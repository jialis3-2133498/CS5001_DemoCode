...
def main():
    ...
    print(cards_dict)
    # What is hashing?
    # In order to make a dict, we need hashable stuff as keys
    # Hashing means immutable things have the same trace number
    # eg. strings, int, tuple are hashable
    # Lists, dict, and sets are not hashable
